<template>
    <div>
        <div>
            <q-btn color="primary" style="position: sticky; z-index: 999; right: 360px" label="Cart"
                   @click="showButton"/>
        </div>
            ...
            <q-card style="width: 1000px; max-width: 80vw;">
                <table class="cart-table">
                    ...
                    <tr v-else v-for="(item, index) in cart" :key="index">
                        ...
                        <td @click="deleteProduct({index, max: item.P, G: item.G, T: item.T})">
                            <q-btn color="primary">Удалить</q-btn>
                        </td>
                    </tr>
                    </tbody>
                </table>
...
<script>
  ...
  import { CART, CHANGE_QUANTITY, DELETE, ITEM_QUANTITY, RATE } from '../consts';
